...
void doAudio(){
    ...
    if(ind[0] > 8192){ ind[0] -= 8192; }

    ind[1] += incr[potArray][1];
    if(ind[1] > 8192){ ind[1] -= 8192; }

    ind[2] += incr[potArray][2];
    if(ind[2] > 8192){ ind[2] -= 8192; }

    ind[3] += incr[potArray][3];
    if(ind[3] > 8192){ ind[3] -= 8192; }

    ind[4] += incr[potArray][4];
    if(ind[4] > 8192){ ind[4] -= 8192; }

    ind[5] += incr[potArray][5];
    if(ind[5] > 8192){ ind[5] -= 8192; }

    ind[6] += incr[potArray][6];
    if(ind[6] > 8192){ ind[6] -= 8192; }
